...
#记得改路径
m_path = '/project/ev_sdk/model/2021.04.29_model_resnet18.pkl'
model = resnet18()
...
#记得改路径
torch.onnx.export(model, dummy_input1,"/project/ev_sdk/model/model.onnx", verbose=True,input_names=input_names,output_names=output_names)
